"""autogenerated by genmsg_py from JointMovementActionResult.msg. Do not edit."""
...
class JointMovementActionResult(roslib.message.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "katana/JointMovementActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','katana/JointMovementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointMovementActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = katana.msg.JointMovementResult()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = katana.msg.JointMovementResult()
