...
class SetInterpolatedIKMotionPlanParamsRequest(roslib.message.Message):
  ...
  _type = "katana_interpolated_ik_motion_planner/SetInterpolatedIKMotionPlanParamsRequest"
...
class SetInterpolatedIKMotionPlanParamsResponse(roslib.message.Message):
  ...
  _type = "katana_interpolated_ik_motion_planner/SetInterpolatedIKMotionPlanParamsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
class SetInterpolatedIKMotionPlanParams(roslib.message.ServiceDefinition):
  _type          = 'katana_interpolated_ik_motion_planner/SetInterpolatedIKMotionPlanParams'
  _md5sum = '351122754b3043b9f5602d68d4eec5db'
